...
export function ProductCard({
  ...
  return (
    <div className={cn("block group cursor-pointer", className)}>
      <div className="relative aspect-3/4 rounded-xl overflow-hidden bg-secondary transition-transform duration-300 group-hover:-translate-y-1 group-hover:shadow-xl group-hover:shadow-primary/20">
        <Image
          src={image}
          alt={name}
          fill
